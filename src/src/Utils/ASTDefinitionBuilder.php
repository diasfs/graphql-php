            ...
            if (isset($this->typeDefintionsMap[$typeName])) {
                ...
                if ($this->typeConfigDecorator) {
                    ...
                    try {
                        ...
                        throw new Error(
                            "Type config decorator passed to " . (get_called_class()) . " threw an error " .
                    ...
                    if (!is_array($config) || isset($config[0])) {
                        throw new Error(
                            "Type config decorator passed to " . (get_called_class()) . " is expected to return an array, but got " .
